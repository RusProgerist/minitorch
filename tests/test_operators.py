...
def test_sigmoid(a: float) -> None:
    ...
    * It is  strictly increasing.
    ...
    assert sigmoid(a - 0.00001) <= sigmoid(a) <= sigmoid(a + 0.00001) or sigmoid(a + 0.00001) <= sigmoid(a) <= sigmoid(a - 0.00001)
...
def test_symmetric() -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    lambda a, b: assert_close(mul(a, b), mul(b, a))
    # raise NotImplementedError('Need to implement for Task 0.2')
...
def test_distribute() -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    lambda x, y, z: assert_close(mul(z, add(x, y)), add(mul(z, x), mul(z, y)))
    # raise NotImplementedError('Need to implement for Task 0.2')
...
def test_other() -> None:
    ...
    """
    # TODO: Implement for Task 0.2.
    lambda x, y, z: assert_close(add(add(x, y), z), add(x, add(y, z)))
    # raise NotImplementedError('Need to implement for Task 0.2')
